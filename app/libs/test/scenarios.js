...
/**
 * 14 Saved Presets for the DeliverBy Preview & Test Simulator.
 * Each scenario simulates tricky real-world situations (cut-offs, weekend rollovers,
 * closures, out-of-stock backorders, customs buffers, peak seasons, timezone offsets).
 */
export const SAVED_SCENARIOS = [
  {
    ...
    subtitle: "14:40 on an ordinary Tuesday",
    badge: "Cut-off",
    orderDate: "2026-09-08", // Tuesday
    orderTime: "14:40",      // After 14:00 cutoff
    country: "IN",
    deliveryMethod: "shipping",
    productId: "mock-tee",
    explanation:
      "When an order arrives past the cut-off time (e.g. 14:00), the warehouse clock does not start until the next working day morning.",
  },
  {
    id: 2,
    number: "02",
  ...
  },
  {
    ...
    badge: "Closure",
    orderDate: "2026-09-07", // Monday
    orderTime: "11:00",
    country: "IN",
    deliveryMethod: "shipping",
    productId: "mock-tee",
    mockClosures: [{ date: "2026-09-08", reason: "Warehouse Maintenance Shutdown" }],
    explanation:
      "When an order is placed right before a public holiday or warehouse shutdown, dispatch and carrier transit skip all closed days seamlessly.",
  },
  {
    id: 4,
    number: "04",
  ...
  },
  {
    ...
    badge: "Buffer",
    orderDate: "2026-12-08", // December peak season
    orderTime: "12:10",
    country: "US",
    deliveryMethod: "shipping",
    productId: "mock-tee",
  ...
  },
  {
    ...
    subtitle: "New York afternoon, Kolkata night",
    badge: "Timezone",
    orderDate: "2026-09-08",
    orderTime: "22:30",
    country: "US",
